        ...
        ${
          user_data.role === "R"
            ? `<div class="flex flex-row items-center justify-between gap-2"> 
                <a href="/restaurant/${restaurant.id}/delete_food/${food.id}/" class="bg-red-500 hover:bg-red-600 text-white rounded-lg p-2 transition duration-300 shadow-md">
                ...
                <a href="/restaurant/${restaurant.id}/update_food/${food.id}" class="bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg p-2 transition duration-300 shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sm:h-8 sm:w-8" viewBox="0 0 20 20" fill="currentColor">
